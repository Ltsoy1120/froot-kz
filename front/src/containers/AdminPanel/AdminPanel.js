            ...
            <div>
              ...
              />
              {
                <div style={{ borderBottom: "1px solid black" }}>
                  ...
                  <p>
                    <b>Фамилия:</b> {value.surname}
                  </p>
                  <p>
                    <b>Отчество:</b> {value.patronymic}
                  </p>
                  <p>
                    <b>Позиция:</b> {value.position}
                  </p>
                  <p>
                    <b>Почта:</b> {value.workEmail}
                  </p>
                  <p>
                    <b>Телефон:</b> {value.phone}
                  </p>
                  <p>
                    <b>Имя в телеграме:</b> {value.telegramName}
                  </p>
                  <NavLink
                    className="AdminPanel__navlink"
                    to={"/users/" + value._id + "/edit"}
                  >
                    Редактировать
                  </NavLink>
                  <NavLink
                    className="AdminPanel__navlink"
                    to={"/users/" + value._id + "/role"}
                  >
                    Редактировать права
                  </NavLink>
                  <button
                    className="AdminPanel__navlink"
                    onClick={() => deleteUserById(value._id)}
                  >
                    Удалить
                  </button>
                </div>
              ...
              {users.map((user, index) => {
                return (
                  ...
                  >
                    ...
                    <p>
                      <b>Почта:</b> {user.workEmail}
                    </p>
                    <p>
                      <b>Телефон:</b> {user.phone}
                    </p>
                    <p>
                      <b>Имя в телеграме:</b> {user.telegramName}
                    </p>
                    <NavLink
                      className="AdminPanel__navlink"
