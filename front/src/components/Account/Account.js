            ...
            {payments &&
              payments.map((payment, index) => (
                <tr key={index}>
                  ...
                  <td>{payment.sum}</td>
                  <td>{`${payment.user && payment.user.surname} ${
                  ...
                  <td>
                    {payment.image ? (
                      <>
                        <a
                          className="Account__btn_img"
                          onClick={() =>
                            openModal(apiURL + "/uploads/" + payment.image)
                          }
                        >
                          Посмотреть
                        </a>
                      ...
                      {payment.repeatability ? (
                        <div className="flex-space">
                          ...
                          <button
                            ...
                            onClick={() => stopRepeatability(payment._id)}
                          >
                            Отменить
                          </button>
                        </div>
                  ...
                  {!registry && user && user.role.includes("viewAllPayments") && (
                    <td>
                      {!payment.approved && (
                        <span style={{ color: "red" }}>Не подтвержден</span>
                      )}
                      {payment.approved && !payment.paided && (
                  ...
                  {registry && user && user.role.includes("approvePayment") && (
                    <td>
                      {!payment.approved ? (
                        <div className="flex-space">
                          <span style={{ color: "red" }}>Не подтвержден</span>
                        ...
                        <div className="flex-space">
                          ...
                          <button
                            className="Account__btn"
                            onClick={() => cancelApprove(payment._id)}
                          >
                            Отменить
                          </button>
                        </div>
